...
<template>
    <header class="site-header d-flex flex-column justify-content-center align-items-center">
      <div class="container">
        <div v-if="attractionStore.connectionStatus" class="row justify-content-center align-items-center">
          <div class="col-lg-8 col-12 mb-5">
            ...
            <div class="d-flex align-items-center mt-5">
              ...
              <a class="custom-icon bi-bookmark smoothscroll" @click="bookMarkValidate(attractionStore.resultDetail.contentId)"></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section v-if="attractionStore.connectionStatus" class="topics-detail-section section-padding" id="topics-detail">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-12 m-auto">
            ...
            <hr />
            <div class="intro">
              <img :src="attractionStore.resultDetail.firstImage" :alt="attractionStore.resultDetail.title" />
            </div>
            <hr />
            <div>
              <p>
              ...
              <button
                ...
                v-if="attractionStore.resultDetail.overview && attractionStore.resultDetail.overview.length > 120"
                @click="toggleText"
              >
            ...
            <div>
              <ul>
                ...
                <li>문의 및 안내: {{ attractionStore.resultDetail.tel ? attractionStore.resultDetail.tel : '추가 예정' }}</li>
              </ul>
            </div>
            <KakaoMap :latitude="attractionStore.resultDetail.latitude" :longitude="attractionStore.resultDetail.longitude"></KakaoMap>
          </div>
        </div>
      </div>
    </section>
